...
class patient_forget_password_otp_check extends StatefulWidget {
  const patient_forget_password_otp_check({super.key});

  @override
  State<patient_forget_password_otp_check> createState() =>
      patient_forget_password_otp_checkState();
}

@override
class patient_forget_password_otp_checkState
    extends State<patient_forget_password_otp_check> {
  @override
            ...
            child: IconButton(
              onPressed: () {
                Navigator.of(context).pushReplacement(MaterialPageRoute(
                    builder: (context) => patient_forget_password_otp_send()));
              },
  ...
  Future checkOtp() async {
    ...
    if (patient_forget_password_otp_sendState.verifyid != "") {
      showDialog(
          context: context,
      ...
      try {
        PhoneAuthCredential credential = PhoneAuthProvider.credential(
            verificationId: patient_forget_password_otp_sendState.verifyid,
            smsCode: otp);
        ...
        patientloginState.forgetpass = true;
        Navigator.of(context).pushReplacement(MaterialPageRoute(
